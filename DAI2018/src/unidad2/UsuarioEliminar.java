...
public class UsuarioEliminar extends JFrame implements ActionListener
{
	...
	public UsuarioEliminar() {
		...
		lbl_imagen_usuario.setBounds(565,20, 180, 150);
	...
	public static void main(String[] args) {
		...
		UsuarioEliminar ejecutar = new UsuarioEliminar();
	...
	public void actionPerformed(ActionEvent a) {
		...
		if(a.getSource()==btn_aceptar) {
			...
			{
				JOptionPane.showMessageDialog(null, "El usuario fu� eliminado correctamente");
			} 
			else 
			{
